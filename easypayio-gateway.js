        ...
        initiatePayment: function(options) {
            ...
            var messageHandler = function(event) {
                ...
                if (event.data.type === 'PAYMENT_SUCCESS') {
                    ...
                    // Mark payment as completed to prevent failure callback
                    paymentCompleted = true;
                    
                    // Clear the window monitoring interval
                    ...
                    // Note: Gateway window stays open so user can see confirmation
            ...
            checkWindowClosed = setInterval(function() {
                if (gatewayWindow.closed) {
                    ...
                    // Only trigger failure if payment wasn't already completed
                    if (!paymentCompleted) {
            ...
            button.addEventListener('click', function(event) {
                ...
                EasyPayIOGateway.pay({
                    ...
                    onFailure: function(error) {
                        console.error('[EasyPayIO] Payment failed:', error);
